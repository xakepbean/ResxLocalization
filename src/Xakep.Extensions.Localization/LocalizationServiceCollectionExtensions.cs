...
namespace Xakep.Extensions.Localization
{
    ...
    public static class LocalizationServiceCollectionExtensions
    {
        ...
        /// </param>
        /// <returns>The <see cref="IServiceCollection"/> so that additional calls can be chained.</returns>
        public static IServiceCollection AddFileLocalization(
            this IServiceCollection services,
            Action<FileLocalizationOptions> setupAction)
        {
            if (services == null)
            {
                throw new ArgumentNullException(nameof(services));
        ...
        {
            services.TryAddSingleton<IStringLocalizerFactory, FileResourceManagerStringLocalizerFactory>();
